  ...
  return (
    <div className="bg-[#0f0f1a] text-white min-h-screen px-6 md:px-16 py-12 font-sans">
      ...
      <section className="text-center mb-20">
        ...
        <button className="mt-6 px-6 py-2 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-full font-semibold text-white">
          Learn More
        </button>
      </section>
      ...
      <section className="mb-20">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="w-full h-56 bg-gradient-to-r from-purple-500 to-cyan-400 rounded-xl"></div>
        </div>
      </section>
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 justify-items-center">
          <div className="bg-[#1a1a2e] p-6 rounded-xl hover:shadow-xl transition-all w-72 h-48 flex flex-col items-center justify-center text-center">
      ...
      <section className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <input
            ...
            className="w-full px-4 py-2 bg-[#1a1a2e] text-white rounded-lg focus:outline-none"
            value={formData.name}
